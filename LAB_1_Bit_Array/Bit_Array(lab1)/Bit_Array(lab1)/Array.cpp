...
void BitArray::swap(BitArray& b)
{
    BitArray A(b);
    b.numBits = numBits;
    b.bits = (bool*)calloc(b.numBits, sizeof(bool));
    if (bits != NULL) memcpy(b.bits, bits, sizeof(b.bits));

    numBits = A.numBits;
    bits = (bool*)calloc(A.numBits, sizeof(bool));
    if (A.bits != NULL) memcpy(bits, A.bits, sizeof(bits));
}
